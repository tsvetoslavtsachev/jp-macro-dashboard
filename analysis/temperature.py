...
BUBBLE_PAIR_PROVENANCE = (
    "Фаза 6 данни-пас (05.08.2026): двойката гори НЕПРЕКЪСНАТО 1987Q1-1990Q2 "
    "(имоти 16/24 × кредит 10-15/24 в балона) и МЪЛЧИ в дефлацията 1995-2012 "
    "и абеномиката 2013-19. Дискриминаторът работи и днес: текущата ера е с "
    "топли имоти (8/16) БЕЗ кредитен крак → двойката неактивна — ценова "
    "топлина без ливъридж не е балон по тази дефиниция. Показанието е сигнал "
    "за СЪ-ПРЕГРЯВАНЕ на цената на актива и кредита — НЕ прогноза и НЕ етикет "
